    ...
    */
    ...
    this.Core = new function Core() {
        ...
        this.init = function init() {
            ...
            // FIXME: timeout to give l10n time to load all the keys
            // this won't be needed once we properly use the configurator
            window.setTimeout(Evme.Brain.Shortcuts.loadFromAPI, 200);
            //window.setTimeout(Evme.Shortcuts.show, 1500);
