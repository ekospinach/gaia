...
var GridManager = (function() {
          ...
          if (currentPage === landingPage) {
            ...
            setOpacityToOverlay = function() {
              ...
              var opacity = opacityOnAppGridPageMax -
                    (Math.abs(deltaX) / windowWidth) * (opacityOnAppGridPageMax - landingPageOpacity);
              overlayStyle.opacity = opacityStepFunction(opacity);
            };
          }
  ...
  function applyEffectOverlay(index) {
    ...
    overlayStyle.opacity = index === landingPage ? landingPageOpacity : opacityOnAppGridPageMax;
  }
