...
var WindowManager = (function() {
  ...
  windows.addEventListener('mozbrowserloadend', function loadend(evt) {
    ...
    // TODOEVME - this kept throwing errors when homescreen launched, bgcolor was null
  ...
  function ensureHomescreen(reset) {
    ...
    if (!isRunning(homescreen)) {
      ...
      // EVME adding Date.now() so the hashchange (in homescreen app) will always happen
